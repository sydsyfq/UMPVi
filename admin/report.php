...
$result2=mysqli_query($conn,"SELECT count(*) as nott from sticker WHERE status = 'NOT VERIFIED'");
$data2=mysqli_fetch_assoc($result2);
$not = $data2['nott'];

$result3=mysqli_query($conn,"SELECT count(*) as yes from sticker WHERE status = 'VERIFIED'");
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      { 
        ...
        if ($row) 
          ...
          <center>
            <h2>Bar Chart of Sticker Application Status</h2>
            <p id="piechart2"></p>
          </center>
  ...
  <script src="../js/demo/chart-pie-demo.js"></script>
          ...
          function drawChart2() {
            ...
            // Optional; add a title and set the width and height of the chart
            var options = {'title':'Bar Chart of Sticker Application Status', 'width':550, 'height':400};
